...
ActiveRecord::Schema.define(version: 20150401171352) do
  ...
  add_index "galleries", ["revenue_id"], name: "index_galleries_on_revenue_id", using: :btree
  ...
  add_index "ingredients", ["revenue_id"], name: "index_ingredients_on_revenue_id", using: :btree
  ...
  add_foreign_key "galleries", "revenues"
  add_foreign_key "ingredients", "revenues"
