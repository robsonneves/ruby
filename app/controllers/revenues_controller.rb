class RevenuesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @revenue.save
        format.html { redirect_to edit_revenue_path(@revenue), notice: 'Revenue was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @revenue.update(revenue_params)
        format.html { redirect_to :back, notice: 'Revenue was successfully updated.' }
  ...
  private
    ...
    def revenue_params
      params.require(:revenue).permit(:name,:category_id,:description,:cover)
    end
end
